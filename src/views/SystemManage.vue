  ...
  <div>
    ...
    <el-tabs type="border-card" border style="margin-top: 25px; width: 100%;">
      <el-tab-pane label="充值">
        <el-form label-position="right" label-width="120px" :model="addFromDataPay" ref="addFromDataPayFrom">
          ...
          <el-form-item>
            <el-button type="primary" @click="submitForm('addFromDataPayFrom')">提 交</el-button>
          </el-form-item>
          <el-form-item>
